...
const TermsAndConditions = () => {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="z-10 flex flex-col rounded-xl bg-light px-6 py-5 font-inter text-white">
        ...
        <div className="flex flex-col gap-4 pt-5">
          <div className="flex flex-col gap-1">
            <h3 className="text-lg text-brand-gold">1. Club Identity</h3>
            <p className="whitespace-pre-wrap text-sm leading-6 text-white">
              Aethernum is a private, anonymous, and unconventional circle, created for individuals
          ...
          <div className="flex flex-col gap-1">
            <h3 className="text-lg text-brand-gold">2. The Concept of Sigillum</h3>
            <p className="whitespace-pre-wrap text-sm leading-6 text-white">
          ...
          <div className="flex flex-col gap-1">
            <h3 className="text-lg text-brand-gold">3. Membership & Access</h3>
          ...
          <div className="flex flex-col gap-1">
            <h3 className="text-lg text-brand-gold">4. Participation & Risk</h3>
            <ul className="list-none pl-0">
              <li className={listStyle}>
                <p className="whitespace-pre-wrap text-sm leading-6 text-white">
          ...
          <div className="flex flex-col gap-1">
            <h3 className="text-lg text-brand-gold">5. Nature of the Club</h3>
            <ul className="list-none pl-0">
              <li className={listStyle}>
                <p className="whitespace-pre-wrap text-sm leading-6 text-white">
          ...
          <div className="flex flex-col gap-1">
            <h3 className="text-lg text-brand-gold">6. Privacy & Anonymity</h3>
            <ul className="list-none pl-0">
              <li className={listStyle}>
                <p className="whitespace-pre-wrap text-sm leading-6 text-white">
          ...
          <div className="flex flex-col gap-1">
            <h3 className="text-lg text-brand-gold">7. Returns & Transparency</h3>
            <ul className="list-none pl-0">
              <li className={listStyle}>
                <p className="whitespace-pre-wrap text-sm leading-6 text-white">
          ...
          <div className="flex flex-col gap-1">
            <h3 className="text-lg text-brand-gold">8. Limitation of Liability</h3>
            <ul className="list-none pl-0">
              <li className={listStyle}>
                <p className="whitespace-pre-wrap text-sm leading-6 text-white">
          ...
          <div className="flex flex-col gap-1">
            <h3 className="text-lg text-brand-gold">9. Applicable Law</h3>
            <ul className="list-none pl-0">
              <li className={listStyle}>
                <p className="whitespace-pre-wrap text-sm leading-6 text-white">
          ...
          <div className="flex flex-col gap-1">
            <h3 className="text-lg text-brand-gold">10. Final Clause</h3>
            <p className="whitespace-pre-wrap text-sm leading-6 text-white">
              Those who enter Aethernum know what they&apos;re stepping into. Do not seek safety. Do
