    ...
    setOptionsData({
      ...
      fill: {
        ...
        gradient: {
          shade: 'dark',
          type: 'vertical',
          gradientToColors: [lineColor || '#00FF94', '#00A3FF'],
          stops: [0, 100],
        },
      },
      tooltip: {
        ...
        custom: ({ series, seriesIndex, dataPointIndex }) => {
          ...
          return `<div style="background-color: #00A3FF33; border: 1px solid #00A3FF; padding: 8px; border-radius: 8px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; gap: 8px;">
                      <p style="color: #00A3FF; font-weight: bold;">${seriesName}</p>
      ...
      <div className="relative flex w-full gap-2">
        <div className="flex flex-col items-start justify-between">
          <div className="flex flex-col items-start">
            <h3 className="text-gradient text-base font-bold">{title}</h3>
