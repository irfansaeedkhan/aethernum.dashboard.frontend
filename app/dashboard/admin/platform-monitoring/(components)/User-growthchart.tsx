...
const UserGrowthChart: React.FC = () => {
    ...
    setOptionsData({
      ...
      tooltip: {
        ...
        custom: ({ series, seriesIndex, dataPointIndex, w }) => {
          ...
          return `<div style="background-color: #0a2540; border: 1px solid #00C1D4; padding: 8px; border-radius: 8px;">
                    <p style="color: white; font-weight: bold;">User Growth</p>
                    <div style="display: flex; justify-content: space-between;">
                      <p style="color: #00FF94;">${time}</p>
                      <p style="color: #00FF94;">${value} Users</p>
                    </div>
                  </div>`;
        },
      },
  ...
  return (
    <div className="overflow-hidden rounded-xl bg-light  p-6">
      <div className="relative flex w-full  gap-4">
        <div className="flex flex-col items-center justify-between pb-4">
          <h3 className="text-gradient text-base font-bold">User Growth</h3>
