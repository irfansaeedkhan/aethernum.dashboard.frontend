...
const AlertActivation = () => {
  ...
  return (
    <div className="overflow-x-auto rounded-2xl bg-light py-5">
      <h5 className="text-gradient mb-2 px-5 text-start text-lg font-bold">
      ...
      <div className="flex items-center justify-start gap-3 border-t border-[#05121E] px-6 py-4 text-sm text-white">
        <div className="flex items-center gap-2">
          <div className="h-2 w-2 rounded-sm bg-[#00FF94]" />
        ...
        <tbody className="flex flex-col justify-between">
          {notifications.map((notif, idx) => (
            <tr key={idx} className="flex items-center border-t border-[#05121E] px-6 py-2">
              ...
              <td className="flex w-1/6 items-center justify-center gap-2 text-xs font-semibold text-[#00FF94]">
                {selectedFreq[notif] ? (
                  <>
                    <div className="h-2 w-2 rounded-sm bg-[#00FF94]" />
                  ...
                  <label className="flex items-center gap-2">
                    <input
                      ...
                      className="
                        ...
                        border-[#00FF94] bg-[#05121E] 
                        text-[#00FF94] checked:border-[#00FF94] 
                        checked:bg-[#00FF94] focus:outline-none focus:ring-0
                      "
                    />
