    ...
    setOptionsData({
      ...
      tooltip: {
        ...
        custom: ({ series, seriesIndex, dataPointIndex }) => {
          ...
          return `
            <div style="background-color: #0B1314; border: 1px solid #FFAA21; padding: 8px; border-radius: 8px;">
              <div style="display: flex; justify-content: space-between; align-items: center; gap: 8px;">
                <p style="color: #FFAA21; font-weight: bold;">Transaction</p>
    ...
    <div className="bg-primary-light rounded-xl p-6">
      <div className="relative  ">
        <div className="flex flex-col items-start justify-between pb-4">
          <h3 className="text-gradient text-base font-bold">High-Value Transactions</h3>
