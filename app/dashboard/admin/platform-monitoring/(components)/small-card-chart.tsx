...
const SmallCardChart: React.FC<SmallCardChartProps> = ({
  ...
  return (
    <div className="h-full w-full rounded-xl bg-light p-4">
      <div className="relative flex h-full w-full flex-col justify-between">
        <div>
          <h3 className="text-gradient mb-1 text-sm font-bold">{title}</h3>
          <p className="my-2 text-3xl font-normal" style={{ color: textColor }}>
            {unit}
