  ...
  return (
    <>
      <div className="flex flex-col gap-4 lg:flex-row">
        ...
        <div className="flex-1 rounded-2xl bg-light py-5">
          <h5 className="text-gradient mb-2 px-5 text-start font-bold">Personalize Report</h5>
        ...
        {/* Right Panel */}
        <div className="w-full rounded-xl bg-light text-white lg:w-[350px]">
          <div className="border-b border-dark p-4">
            ...
            <input
              ...
              className="w-full rounded-lg border border-[#1A2638] bg-dark px-4 py-2 text-white placeholder-brand-gold focus:outline-none focus:ring-2 focus:ring-[#00BFFF]"
            />
          </div>
            ...
            <div className="mb-4 flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <input
                  type="text"
                  placeholder="MM"
                  className="w-16 rounded-md border border-[#1A2638] bg-dark px-2 py-2 text-center text-white placeholder-brand-gold"
                />
                <input
                  type="text"
                  placeholder="YYYY"
                  className="w-20 rounded-md border border-[#1A2638] bg-dark px-2 py-2 text-center text-white placeholder-brand-gold"
                />
              </div>
            </div>
      ...
      {/* Footer */}
      <div className=" flex w-full items-center justify-between rounded-2xl bg-light p-4 text-white">
