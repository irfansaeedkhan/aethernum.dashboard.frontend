      ...
      <div className="flex flex-col gap-8 pb-20">
        <div className="flex w-full flex-col gap-5 lg:gap-14">
          ...
          <div className="flex w-full flex-col justify-center gap-5 sm:flex-row sm:items-center">
            <div className="flex w-full items-center justify-between gap-2 rounded-3xl bg-light p-4 sm:w-2/4">
              <h5 className="text-gradient font-kanit text-base">Event Tracking</h5>
              <Link href="/dashboard/admin/platform-monitoring/event-tracking">
                <Button
                  title="Track Now"
                  className="rounded-full !px-8 !py-2 capitalize md:!py-2"
                />
              </Link>
            </div>
            <div className="flex w-full items-center justify-between gap-2 rounded-3xl bg-light p-4 sm:w-2/4">
              <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center">
                <h5 className="text-gradient font-kanit text-base">Track Rewards</h5>
