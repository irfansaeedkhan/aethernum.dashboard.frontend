...
import { BlueFlagIcon, RedFlagIcon } from '@/assets/svgs';
      ...
      renderCell: row => (
        <div className="flex gap-2">
          <Button
            ...
            variant="outlineBlue"
            className="rounded-full !px-3 !py-1 text-[10px] capitalize"
            onClick={() => {
      ...
      <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="relative w-full max-w-md">
          <input
            ...
            className="w-full rounded-full bg-dark px-4 py-3 text-xs text-white placeholder:text-brand-gold focus:outline-none focus:ring-2 focus:ring-brand-gold"
          />
          <SearchNormalIcon className="text-gray-400 absolute right-3 top-1/2 -translate-y-1/2" />
        </div>
      </div>

      <div className="bg-gray-800 overflow-hidden rounded-2xl">
