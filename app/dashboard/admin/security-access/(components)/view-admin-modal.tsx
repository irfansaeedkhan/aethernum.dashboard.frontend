      ...
      <div className="relative w-full max-w-4xl rounded-xl bg-light text-white">
        <div className="p-6">
          ...
          <div className="mb-6 grid grid-cols-4 gap-4  p-6 text-sm">
            <div>
              <p className="mb-1 text-xs text-brand-gold">ActionID</p>
              <p>{admin.actionId}</p>
            </div>
            <div>
            ...
            <div>
              <p className="mb-1 text-xs text-brand-gold">Admin ID</p>
              <p>{admin.adminId}</p>
            </div>
            <div>
              <p className="mb-1 text-xs text-brand-gold">Admin Username</p>
              <p>{admin.username}</p>
            </div>
            <div>
              <p className="mb-1 text-xs text-brand-gold">Admin Email</p>
              <p>{admin.email}</p>
            </div>
            <div>
              <p className="mb-1 text-xs text-brand-gold">Action Type</p>
