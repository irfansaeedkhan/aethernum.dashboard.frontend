      ...
      renderCell: row => (
        <div className="flex gap-2">
          <Button
            title="View Admin"
            variant="outlineBlue"
            className="!px-4 !py-1 text-[10px] capitalize"
            onClick={() => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="--grid hidden grid-cols-3 gap-6">
        <div className="flex items-center justify-between rounded-xl bg-light p-4 text-white">
          <CreateAdminIcon />

          <div className="flex flex-col items-center">
            <p className="text-gradient mb-2 text-base">Create new Admin</p>
            <Button
              title="Create"
              variant="primary"
        ...
        <div className="flex items-center justify-between rounded-xl bg-light p-4 text-white">
          ...
          <div className="flex flex-col items-center">
            <p className="text-gradient mb-2 text-base">Manage Admin</p>
            <Button
              title="Manage"
              variant="primary"
              className="!px-6 !py-2 text-[10px] capitalize"
        ...
        <div className="flex items-center justify-between rounded-xl bg-light p-4 text-white">
          ...
          <div className="flex flex-col items-center">
            <p className="text-gradient mb-2 text-base">Active Sessions</p>
