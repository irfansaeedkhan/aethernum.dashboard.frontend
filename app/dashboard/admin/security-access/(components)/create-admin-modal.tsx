...
import { CalendarIcon, SearchNormalIcon } from '@/assets/svgs';
...
const CreateAdminModal: React.FC<CreateAdminModalProps> = ({
      ...
      renderCell: () => (
        <div className="flex items-center gap-2">
          <Button
            title="View Detail"
            variant="outlineBlue"
            className="!px-3 !py-2 text-[10px] capitalize"
            onClick={() => {
              /* view detail logic */
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-5xl rounded-xl bg-light text-white">
        <div className="p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-end gap-4 pt-4">
                <Button
                  title="Restore"
                  variant="primary"
                  className="!px-8 !py-2 text-[10px] capitalize"
                  onClick={() => {
                  ...
                  {[
                    ...
                    <div key={label} className="flex flex-col gap-1">
                      <SingleCheckbox
                        ...
                        label={label}
                      />
                      {subtitle && <p className="text-[10px] text-brand-gold">{subtitle}</p>}
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="--flex hidden items-center justify-end gap-4">
                <div className="relative">
                  <button
                    ...
                    className="
                      flex items-center gap-2 rounded bg-dark px-4 py-2
                  ...
                  {auditDateFilter === 'Custom' && (
                    <div className="absolute left-0 top-[calc(100%+4px)] z-10 w-full rounded bg-dark shadow-lg">
                      <div className="p-2 text-sm text-brand-gold">(Calendar placeholder)</div>
                    </div>
                  )}
                </div>
