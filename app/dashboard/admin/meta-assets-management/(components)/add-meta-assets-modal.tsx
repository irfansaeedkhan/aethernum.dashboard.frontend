...
const AddSigillumModal: React.FC<AddSigillumModalProps> = ({ isOpen, onClose }) => {
  ...
  const fetchUsers = useCallback(async () => {
    setLoading(true);
    try {
      const response = await getEmployees(1, 100); // Fetch first 100 users
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center bg-[#0A0A0EBF] backdrop-blur-sm">
      <div className="relative w-full max-w-2xl rounded-xl bg-light p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {activeTab === 'manual' ? (
            <div className="space-y-6 rounded-xl bg-light pt-3">
                ...
                <div>
                  ...
                  <div ref={dropdownRef} className="relative">
                    <button
                      ...
                      className="flex w-full items-center justify-between rounded-full bg-dark px-4 py-2.5 text-left text-sm text-brand-gold focus:outline-none"
                    >
                      <span className={selectedUser ? 'text-brand-gold' : 'text-gray-500'}>
                        {selectedUser
                    ...
                    {showUserDropdown && (
                      <div className="absolute z-10 mt-2 w-full rounded-xl border border-white/20 bg-dark shadow-lg">
                        <div className="border-b border-white/10 p-2">
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full rounded-lg bg-light px-10 py-2 text-sm text-white placeholder-gray-400 focus:outline-none"
                              autoFocus
                            />
                          </div>
                        </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-full bg-dark px-4 py-2.5 pr-10 text-sm text-brand-gold placeholder:text-gray-500 focus:outline-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                      min="0"
                      step="1"
                    />
                    <div className="absolute right-2 top-1/2 flex -translate-y-1/2 flex-col">
                      <button
                        ...
                        className="flex h-3 w-4 items-center justify-center text-white/60 hover:text-brand-gold transition-colors"
                      >
                        <ChevronUp size={12} />
                      </button>
                      <button
            ...
            <div className="space-y-6 rounded-xl bg-light pt-3">
              ...
              <div className="rounded-lg bg-dark/50 p-4">
                ...
                <p className="text-sm leading-relaxed text-white/80">
                  Upload an Excel file (.xlsx or .xls) with columns: <span className="font-medium text-brand-gold">Email</span> and{' '}
                  <span className="font-medium text-brand-gold">Count</span>
                </p>
              </div>
              ...
              <div>
                ...
                <Button
                  title="Upload"
                  variant="outlineBlue"
                  className="rounded-full !px-6 !py-2 text-sm capitalize"
              ...
              <div>
                <button
                  ...
                  className="flex items-center gap-2 text-sm text-brand-gold hover:text-brand-mint transition-colors"
                >
                  <Download size={16} />
              ...
              <div className="flex justify-end pt-4">
                <Button
                  title="Add"
                  variant="primary"
                  className="rounded-full !px-8 !py-2 text-sm capitalize"
                  type="button"
