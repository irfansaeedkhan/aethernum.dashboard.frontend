    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:gap-4">
          <div className="flex w-[40%] items-center justify-between rounded-[20px] bg-dark px-4 py-3">
            <span className="text-gradient text-base">Add Sigillum:</span>
            <Button
              variant="primary"
              title="Add"
              className="rounded-full !px-8 !py-2 text-[10px] capitalize"
              onClick={openAddModal}
            />
          </div>
          <div className="flex w-[60%] items-center justify-between rounded-[20px] bg-dark px-4 py-3">
            <div className="flex flex-row items-center gap-2">
              <span className="text-gradient text-base">Track Asset Growth:</span>
