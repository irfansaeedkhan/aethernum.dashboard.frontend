...
export default function DemoProfileModal({ isOpen, onClose, onSuccess }: DemoProfileModalProps) {
  ...
  return (
    <ModalContainer
      ...
      isOpen={isOpen}
      onClose={handleClose}
      modalContentClassName="max-w-4xl rounded-xl bg-light p-6 text-white"
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-6">
        <div className="w-full space-y-6 pt-4">
          <div className="grid grid-cols-2 gap-6">
            <div>
              <label className="mb-2 flex items-center gap-2 text-sm font-medium text-brand-gold">
              ...
              <input
                ...
                className={`placeholder-gray-400 w-full rounded-full bg-dark px-6 py-3 text-sm text-white transition-colors focus:outline-none ${
                  errors.name
                    ? 'border-2 border-brand-red'
                    : 'border-2 border-transparent focus:border-brand-gold'
                }`}
              />
              ...
              <Controller
                ...
                render={({ field }) => (
                  <PhoneInput
                    ...
                    defaultCountry="US"
                    className={`w-full rounded-full bg-dark px-6 py-3 text-sm text-white transition-colors focus:outline-none ${
                      errors.phoneNumber
                        ? 'border-2 border-brand-red'
                        : 'border-2 border-transparent focus:border-brand-gold'
                    } [&>input]:placeholder-gray-400 [&>input]:border-0 [&>input]:bg-dark [&>input]:text-white [&>input]:outline-none [&>input]:ring-0`}
                  />
                )}
              />
              {errors.phoneNumber && (
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <div
                className={`flex items-center rounded-full bg-dark px-6 py-3 text-sm transition-colors ${
                  errors.password
                    ? 'border-2 border-brand-red'
                    : 'border-2 border-transparent focus-within:border-brand-gold'
                }`}
              >
                <input
        ...
        <div className="flex w-full items-center justify-between border-t border-white/10 pt-6">
          ...
          <Button
            ...
            variant="primary"
            className="!px-12 !py-3 text-xs font-medium uppercase disabled:opacity-50"
            type="submit"
