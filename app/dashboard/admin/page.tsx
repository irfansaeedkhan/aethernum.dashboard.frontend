      ...
      <div className="flex w-full flex-col gap-5 lg:gap-14">
        ...
        {pathname === AdminAppRoutes.dashboard.index && (
          <div className="flex w-full flex-col gap-5  sm:flex-row sm:items-center">
            <div className="flex w-full items-center justify-between gap-2 rounded-3xl bg-light p-4 sm:w-2/5">
              <h5 className="text-gradient font-kanit text-base">Add Sigillum:</h5>
              <Button
                title="Add"
            ...
            <div className="flex w-full items-center justify-between gap-2 rounded-3xl bg-light p-4 sm:w-3/5">
              <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center">
                <h5 className="text-gradient font-kanit text-base">Add Sigillum:</h5>
                <p className="text-xs text-white">Weekly/monthly reports on new purchases</p>
              </div>
              <Button title="View Report" className="rounded-full !py-2 md:!py-2" />
            </div>
          </div>
        )}
      </div>
