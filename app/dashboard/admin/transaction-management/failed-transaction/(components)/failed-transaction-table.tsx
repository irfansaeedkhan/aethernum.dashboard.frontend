    ...
    },
    {
      ...
      renderCell: row => {
        if (row.status === 'Successful') {
          ...
          return <span className="text-brand-gold">{row.status}</span>;
        } else {
      ...
      renderCell: row => (
        <div className="flex items-center justify-center gap-2">
          ...
          <button
            className="
              rounded-full 
              bg-gradient-to-r from-[#FFD46E] to-[#FF7337] 
              px-4 py-1 
              text-xs text-[#05121E] 
        ...
        <div className="flex flex-row justify-between">
          ...
          <div className="relative flex flex-col items-end justify-between gap-4">
            ...
            <p className="text-sm text-brand-gold">
              ...
              &nbsp;
              <span className="text-brand-gold">Failed Transactions</span>
            </p>
