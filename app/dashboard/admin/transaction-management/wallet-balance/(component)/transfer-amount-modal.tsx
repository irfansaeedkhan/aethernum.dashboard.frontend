...
import { ArrowSquareDownIcon, MoneySendIcon, MoneyReciveIcon } from '@/assets/svgs';
          ...
          <div className="mr-8 flex flex-col gap-6 text-sm">
            <button
              ...
              className={`flex items-center space-x-2 ${
                activeTab === 'add' ? 'text-[#00FF94]' : 'text-white'
              }`}
            >
              <MoneySendIcon
                className={`flex items-center space-x-2 ${
                  activeTab === 'add' ? '[&>path]:fill-[#00FF94]' : '[&>path]:fill-white'
                }`}
              />
              <span>Add</span>
            </button>
            ...
            <button
              ...
              className={`flex items-center space-x-2 ${
                activeTab === 'withdraw' ? 'text-[#00FF94]' : 'text-white'
              }`}
            >
              <MoneyReciveIcon
                className={`flex items-center space-x-2 ${
                  activeTab === 'withdraw' ? '[&>path]:fill-[#00FF94]' : '[&>path]:fill-white'
                }`}
              />
              <span>Withdraw</span>
            </button>
              ...
              <div className="relative flex-1 px-2 text-xs">
                {activeTab === 'add' ? (
                  ...
                  <input
                    ...
                    className="
                      h-[2.5rem] w-full rounded bg-dark px-3 py-3 
