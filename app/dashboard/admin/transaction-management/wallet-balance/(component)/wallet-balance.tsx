    ...
    (): Column<UserRow>[] => [
      ...
      },
      {
        ...
        renderCell: (row: UserRow): React.JSX.Element => {
          ...
          else if (row.status === 'Inactive') cls = 'text-brand-gold';
    ...
    <>
      <div className="bg-primary p-6 text-white">
        <main className="space-y-6">
          <div className="flex flex-col gap-6 rounded-xl">
            <div className="flex w-full items-center justify-between">
              ...
              <h2 className="text-2xl font-semibold">
                <span className="text-gradient bg-clip-text">Wallet Balance & Management</span>
              </h2>
            ...
            <div className="flex w-full items-center justify-between pt-6">
              ...
              <div className="relative w-[420px]">
                <input
                  ...
                  className="
                    w-full rounded-full bg-dark px-4 py-3 
                    text-xs text-white placeholder:text-brand-gold
          ...
          {/* ─── “User Wallets” Table ───────────────────────────────────────────── */}
          {activeTab === 'user' && (
            <div className="overflow-x-auto rounded-2xl bg-light">
          ...
          {/* ─── “Statistics” Tab ────────────────────────────────────────────────── */}
          {activeTab === 'stats' && (
            <div className="overflow-x-auto rounded-2xl bg-light p-6">
