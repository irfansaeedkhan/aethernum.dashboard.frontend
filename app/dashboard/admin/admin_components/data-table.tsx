...
type Filters = Partial<Record<string, string>>;
  ...
  const setPage = isExternalPagination ? externalPagination.onPageChange : setInternalPage;
  ...
  return (
    <div className="w-full max-w-none mx-auto lg:max-w-[calc(100vw-20rem)] xl:max-w-[calc(100vw-18rem)]">
      ...
      >
        <div
          className="max-w-none overflow-x-auto overflow-y-auto lg:max-w-[calc(100vw-18rem)] xl:max-w-[calc(100vw-18rem)]"
          style={{
            maxHeight:
              pageData.length !== 0
                    ...
                    <div className="flex items-center justify-center gap-2">
                      ...
                      {col.sortable && col.accessor && (
                        <button onClick={() => toggleSort(col.accessor!)} className="group shrink-0">
                          <UpDownIcon className="group-hover:[&>g]:fill-brand-gold" />
                        </button>
                      )}
                      {/* Filter dropdown */}
                      {col.filterOptions && (
                        <div className="relative z-20 inline-block">
                          ...
                          >
                            <ArrowDownIcon className="shrink-0 scale-75 group-hover:[&>path]:fill-brand-gold" />
                          </button>
