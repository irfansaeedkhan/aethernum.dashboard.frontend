...
const NotificationModal: React.FC<NotificationModalProps> = ({ isOpen, onClose, notification }) => {
  ...
  const columns: Column<any>[] = [
    ...
    { key: 'holdings', header: 'Asset holdings', accessor: 'holdings' },
    {
      key: 'affiliates',
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center bg-[#0A0A0EBF] backdrop-blur-sm">
      ...
      <div className="relative w-full max-w-6xl rounded-xl border border-[#0E1F30] bg-light text-white">
        <div className="p-6">
            ...
            <div className="space-y-6 rounded-xl bg-light p-6 text-sm">
              ...
              <div className="flex gap-4">
                <div className="w-1/2">
                  ...
                  <input
                    ...
                    className="w-full rounded bg-dark p-2 text-sm placeholder-brand-gold"
                  />
                </div>
                <div className="w-1/2">
              ...
              <div className="flex gap-4">
                <div className="w-1/2">
                  ...
                  <select
                    ...
                    className="w-full rounded bg-dark p-2 text-brand-gold"
                  >
              ...
              <div className="flex justify-end">
                <Button
                  title="Next"
                  variant="outlineBlue"
                  className="rounded-full !px-10 !py-2 text-[10px] capitalize"
                  onClick={() => setStep(1)}
                />
              </div>
            </div>
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <div className="relative w-1/3">
                  <input
                    ...
                    className="w-full rounded-full bg-dark px-4 py-3 text-xs placeholder-brand-gold focus:outline-none focus:ring-2 focus:ring-brand-gold"
                  />
          ...
          {step === 2 && (
            <div className="space-y-6 rounded-xl p-6 text-sm">
              {/* Publish & Status */}
              ...
              <div className="grid grid-cols-3 gap-8 text-xs">
                <div>
                  <p className="mb-1 text-sm text-brand-gold">Created on</p>
                  <p>12 JAN 2024</p>
                </div>
                <div>
                  <p className="mb-1 text-sm text-brand-gold">Released on</p>
                  <p>12 JAN 2024</p>
                </div>
                <div>
                  <p className="mb-1 text-sm text-brand-gold">Suspended on</p>
                  <p>12 JAN 2024</p>
                </div>
              </div>
              ...
              {/* Target Users List */}
              <div>
                <div className="scrollbar-thumb-rounded-full scrollbar-track-rounded-full  max-h-40 overflow-y-auto rounded p-3 scrollbar-thin scrollbar-track-dark scrollbar-thumb-brand-gold">
