    ...
    >
      <div className="flex w-full flex-col gap-12">
        <div className="flex flex-col items-center justify-center gap-3">
          ...
          <span className="font-nexa text-sm font-normal text-white">Sign up to aethernum</span>
        </div>
        ...
        <div className="flex justify-center gap-0.5 pb-6 text-sm text-white md:text-base">
          ...
          <Link href={AppRoutes.auth.login} className="cool-link cursor-pointer text-brand-gold">
            Log In
          </Link>
        </div>
      </div>
