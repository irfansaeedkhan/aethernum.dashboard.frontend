...
export const ProfileCommonTop = () => {
  ...
  return (
    <div className="--max-w-[1081px] mx-auto flex w-full flex-col">
      <div className="flex w-full items-start justify-between rounded-tl-xl rounded-tr-xl bg-light p-4 text-white lg:rounded-xl  lg:p-3">
      ...
      <div className="flex w-full items-center justify-between rounded-bl-xl rounded-br-xl bg-light p-4 lg:hidden lg:p-3">
        ...
        <Link href={AppRoutes.profile.terms}>
          <Button
            className={clsx(
              'w-fit rounded-xl border-transparent bg-transparent px-2  py-1 text-xs capitalize  text-white opacity-90 lg:px-4 lg:py-2 [&>span]:!h-[15px] [&>span]:!font-nexa [&>span]:!font-normal lg:[&>span]:text-sm',
