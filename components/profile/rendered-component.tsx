...
export const RenderedComponent = () => {
  ...
  return params.get('tab') === 'terms' ? (
    <div className="--max-w-[1081px] mx-auto w-full p-4 sm:p-6 md:p-8">
      ...
      <p className={pClass}>
        <span>
          <span className={boldClass}>Thank you for visiting aethernum.club. </span>
          By visiting, accessing, or using app.aethernum.club and associated application program
          interface or mobile applications (“aethernum Platform”), you (“User”, “user”, “You” or
        ...
        <span>
          ...
          (“OKC EU”), which operates under the aethernum brand, for Users who are residents of one
        ...
        <span>
          ...
          company (“Aux Cayes”), for all other Users eligible to access and use aethernum&apos;s
          Services.
        </span>
        <span>
          Where the term “aethernum” is used in these Terms, it shall mean either OKC EU, aethernum
          Bahamas, aethernum HK, aethernum Brazil, aethernum Singapore, or Aux Cayes as the case may
      ...
      <p className={pClass}>
        <span>
          ...
          Terms, and you have not previously been suspended or removed from the aethernum Platform
        ...
        <span>
          ...
          Japan, the Bahamas and the Netherlands are not permitted to open new accounts at aethernum
