        ...
        <div className={clsx('flex w-full flex-grow flex-col gap-4 md:flex-row')}>
          ...
          <div className={clsx(inputMain, 'flex-1')}>
            ...
            <PhoneInput
              ...
              className={clsx(
                inputField,
                'bg-brand-gold py-[0.938rem] focus:[&>input]:border-0 focus:[&>input]:outline-none focus:[&>input]:ring-0'
              )}
            />
          </div>
        </div>
...
const inputField =
  'peer relative w-full bg-dark pl-6 pr-4 font-thin outline-none drop-shadow-sm transition-all duration-200 ease-in-out focus:primary focus:ring-2 focus:ring-primary focus:drop-shadow-lg py-3 rounded-full text-base text-white [&>input]:border-0 [&>input]:outline-none [&>input]:ring-0 [&>input]:bg-primary';
