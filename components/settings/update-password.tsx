...
import { calculatePasswordStrength } from '../auth/register/strength-meter';
...
const passwordField =
  'peer relative w-full bg-dark pl-6 pr-4 font-thin outline-none drop-shadow-sm transition-all duration-200 ease-in-out focus:dark focus:ring-2 focus:ring-dark focus:drop-shadow-lg py-3 rounded-full text-base text-white';
