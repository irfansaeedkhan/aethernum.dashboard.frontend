...
export const RewardsCard: React.FC<Props> = ({ refferalRewards }) => {
  return (
    <div className="flex w-full flex-col justify-between lg:gap-8 gap-4 rounded-xl bg-light p-6 text-white md:flex-row">
      ...
      <div className="flex-1 md:px-6">
        ...
        {/* <div className="mt-4 flex flex-col gap-2 pl-4">
          {refferalRewards?.level_1 !== undefined && (
            <div className="flex items-center justify-between gap-4">
              <span className="text-xs text-[#666666] md:text-sm">Level 1</span>
              <span className="text-sm font-medium text-white md:text-base">
                {refferalRewards.level_1}
              </span>
            </div>
          )}
          {refferalRewards?.level_2 !== undefined && (
            <div className="flex items-center justify-between gap-4">
              <span className="text-xs text-[#666666] md:text-sm">Level 2</span>
              <span className="text-sm font-medium text-white md:text-base">
                {refferalRewards.level_2}
              </span>
            </div>
          )}
          {refferalRewards?.level_3 !== undefined && (
            <div className="flex items-center justify-between gap-4">
              <span className="text-xs text-[#666666] md:text-sm">Level 3</span>
              <span className="text-sm font-medium text-white md:text-base">
                {refferalRewards.level_3}
              </span>
            </div>
          )}
        </div> */}
