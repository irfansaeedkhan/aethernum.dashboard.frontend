...
const SigillumDetailComponent: React.FC<Props> = ({ onOpenBuySigillumModal, SigillumDetails, onOpen }) => {
  ...
  if (!SigillumDetails) {
    return (
      <div className="w-fullrounded-xl rounded-xl bg-light px-6 py-8  text-white">
          <div className="flex flex-col gap-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm text-brand-gold  lg:text-lg xl:text-xl">Sigillum Details</p>
              </div>
              <Button
                title="Buy Sigillum"
                className="hidden w-full max-w-max lg:block  lg:!px-6 lg:!py-2"
            ...
            <Button
              title="Buy Sigillum"
              className="mt-2 block w-full lg:hidden  lg:!px-6 lg:!py-2"
              onClick={handleBuyMetaClick}
            />
  ...
  return (
    <div className="w-full rounded-xl bg-light p-6  text-white">
        <div className="flex flex-col gap-6 h-full justify-between">
          ...
          <div className="grid grid-cols-1 gap-7 xxl:grid-cols-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm text-brand-gold ">{received_rewards} / 50</p>
            </div>
            <div className="flex flex-col gap-1">
              <p className="text-xxs text-white">US$ Earned Until Now</p>
              <p className="flex items-center gap-1 text-sm text-brand-gold ">
