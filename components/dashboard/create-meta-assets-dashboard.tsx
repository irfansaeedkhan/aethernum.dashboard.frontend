...
export const CreateSigillumDashboard: React.FC<Props> = ({
  ...
  return (
    <div className="col-span-1 flex h-auto w-full flex-col gap-4 rounded-xl bg-light px-2 py-6 md:p-6">
      ...
      {SigillumDetails?.owned_offices ? (
        <div className="mt-4 flex items-center gap-2 rounded-2xl bg-light p-4">
          <ExclaimationIcon className="size-8 shrink-0 cursor-pointer stroke-2" />
          <h3 className="pt-1 font-kanit text-xs font-normal text-brand-gold sm:text-sm">
      ...
      <div className="mt-1 flex h-full flex-col justify-between gap-[14px]">
        <div className="mt-1 flex flex-col gap-[14px]">
          ...
          <div className="flex items-start justify-between gap-2">
            <h3 className="text-sm font-medium text-brand-gold">ETH equivalent</h3>
        ...
        <div className="mt-4 flex flex-col gap-4">
          ...
          {/* invoice-reset <Button
            ...
            className="!w-full text-sm md:text-base [&>span]:uppercase"
          /> */}
        </div>
      </div>
      <CreateOrderModal
