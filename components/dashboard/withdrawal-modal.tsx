      ...
      >
        <div className="flex w-full flex-col items-center text-center">
          ...
          <div className="content pb-8 pt-3">
            <h3 className="text-gradient mx-auto pb-2 pt-1 text-center text-base font-semibold capitalize sm:text-lg">
              Demo Account
            </h3>
          ...
          <Button
            title="Got it"
            className="w-full text-sm md:text-base lg:!px-10 lg:!py-3"
            onClick={onClose}
          />
        </div>
      </ModalContainer>
      ...
      <div className="flex w-full flex-col gap-6">
          ...
          <>
            <div className="flex items-center justify-between gap-5">
              <div className="flex items-center gap-2">
                <h3 className="text-base font-normal text-white sm:text-xl">Withdraw</h3>
              </div>
            ...
            <div className="flex flex-col gap-1 pt-5">
              ...
              <div className="focus:light peer relative flex w-full cursor-pointer rounded-full bg-dark py-3 pl-6 pr-4 text-base font-thin text-white outline-none drop-shadow-sm transition-all duration-200 ease-in-out focus:ring-2 focus:ring-primary focus:drop-shadow-lg">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="peer relative w-full rounded-full bg-dark py-3 pl-6 pr-4 text-base font-thin text-white outline-none drop-shadow-sm transition-all duration-200 ease-in-out focus:ring-2 focus:ring-primary focus:drop-shadow-lg"
              />
            </div>
            <div className="flex flex-col gap-2">
              ...
              <div className="border-gray-shade-1/10 peer relative flex h-12 w-full min-w-0 items-center rounded-full border bg-dark px-2 py-3 pl-6 pr-4 text-xs font-thin text-white shadow-1 outline-none drop-shadow-sm transition-all duration-200 ease-in-out focus-within:border-primary focus:ring-2 focus:ring-primary focus:drop-shadow-lg">
                <input
                  type="text"
                  name="amount"
                  id="amount"
                  ...
                  className="min-w-0 flex-1 bg-dark text-base font-thin text-white focus:outline-none"
                  inputMode="decimal"
                />
                <div className="flex shrink-0 items-center justify-end gap-1.5">
                  <span className="flex shrink-0 items-center gap-1.5 rounded-full p-1.5 text-xs font-medium">
                    <span>ETH</span>
                  </span>
                  <span
                    className="shrink-0 cursor-pointer rounded-full pl-2 text-xs font-medium text-brand-gold"
                    onClick={() =>
                      setFormFields({
                        ...formFields,
            ...
            <div className="flex items-start justify-between gap-2">
              <h3 className="text-sm font-medium text-brand-gold">US$ equivalent</h3>
              <div className="flex flex-col items-end gap-2">
                <h3 className="text-bold text-base text-brand-gold">
            ...
            <div className="flex items-center gap-2 p-3">
              ...
              <div className="flex flex-col gap-1">
                <h3 className="pt-1 font-kanit text-xs font-black text-brand-gold sm:text-sm">
                  Reminder
                </h3>
                <p className="text-xxs font-normal text-brand-gold">
        ...
        {failure && (
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            <Button title="Ok" className="mt-4 w-full text-sm md:text-base" onClick={handleClose} />
          </div>
        )}
      </div>
    </ModalContainer>
