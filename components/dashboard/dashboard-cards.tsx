...
interface Props {
  ...
  setRewardListPage?: React.Dispatch<React.SetStateAction<number>>;
  rewardListTotalPages?: number;
  ...
  return (
    <div className="z-10">
      ...
      <RewardListlModal
        ...
        page={rewardListpage}
        setPage={setRewardListPage}
        totalPages={rewardListTotalPages}
      />
    </div>
  );
};
