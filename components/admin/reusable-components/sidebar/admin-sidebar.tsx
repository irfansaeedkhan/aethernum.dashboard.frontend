  ...
  return (
    <div className="z-50 w-full max-w-[260px] overflow-x-hidden lg:overflow-visible">
      <div className="hidden h-full items-center justify-center md:mx-6 md:flex md:py-[0.625rem]">
        <div className="relative hidden h-[calc(100%-16px)] w-full flex-shrink-0 flex-col justify-between rounded-lg bg-light p-[0.625rem] lg:flex">
                  ...
                  >
                    <item.icon
                      className={clsx(
                        ...
                        isActive ? 'fill-brand-gold' : 'fill-white'
                      )}
                    />
                    <p
                      className={clsx(
                        'text-sm font-medium lg:block',
                        isActive ? 'text-brand-gold' : 'lg:group-hover:cool-link text-white'
                      )}
                    >
                      {item.title}
                    </p>
