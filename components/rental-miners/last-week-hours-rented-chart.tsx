...
const LastWeekHoursRentedChart: React.FC<prop> = ({ data }) => {
  ...
  return (
    <div className="z-10 w-full rounded-xl border border-white/10 bg-light p-4 text-white md:p-5">
        ...
        <div className="flex w-full flex-col items-end gap-2">
          ...
          <div className="mr-1 mt-1 flex gap-5">
            <div className="flex items-center gap-1 text-white maxmobile:self-end">
              <div className="h-2 w-2 rounded-full border border-white bg-[#087EF5]"></div>
              <span className="text-[0.375rem] md:text-[0.625rem]">rHd</span>
            </div>
            <div className="flex items-center gap-1 text-white maxmobile:self-end">
              <div className="h-2 w-2 rounded-full border border-white bg-[#FFAA21]"></div>
