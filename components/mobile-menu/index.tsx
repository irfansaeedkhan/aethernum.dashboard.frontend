        ...
        <div className={`z-50 w-full overflow-x-hidden lg:overflow-visible `}>
          ...
          >
            ...
            <div className="flex h-full flex-1 flex-col justify-between">
              <div className="flex flex-col">
                <div className="flex items-center justify-center gap-4 px-6 pt-14">
                  ...
                  >
                    ...
                    <span className={clsx('text-gradient flex-shrink-0 pt-1 text-sm font-medium')}>
                      View Profile
                    </span>
                  </Link>
                </div>
              ...
              <div className="mb-10 mt-auto flex w-full flex-col items-center justify-start gap-4 px-6 pb-[calc(env(safe-area-inset-bottom)+4.5rem)]">
                <Button
                  title="View Tutorial"
                  variant="outline-new"
                ...
                <Button
                  title="logout"
                  className="w-full text-sm md:text-base lg:!py-2"
